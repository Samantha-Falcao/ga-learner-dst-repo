# --------------
#It's with an emergency that an agency wishes to use the skills that you learned in 'python intermediate' module. Your mission if you choose to accept it, would be to help us decipher a message that we received from our intel. We have multiple text files that need to be read and have certain operations performed to get our final message.
...
def compare_msg(message_d,message_e):
    ...
    c_list= []
    for x in a_list:
        if x in a_list and x not in b_list:
            c_list.append(x)
...
#Calling the function 'extract_msg'
